"""The journal metadata stamp: three writers, one file, and a reader that is really total.
...
5. Reading is total, and writing is total in the matching sense. Absent, corrupt, or
