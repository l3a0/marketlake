...
1. The URL names which check was fed. That is how the suite covers the rule that a ping
...
2. A place in a shared event log fixes when the ping happened against the other steps
   of a job. The compaction and runner tests read it to check their ordering: the backup
