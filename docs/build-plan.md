...
6. **D20a**, the battery's one page, the delayed feed. Schema drift already pages from the parser and from compaction, so the battery adds one page class rather than two.
