...
- **[#265](https://github.com/l3a0/marketlake/issues/265).** The half of the parser's schema-drift page a vanished field leaves no trace of. [#197](https://github.com/l3a0/marketlake/issues/197) shipped the producer, the once-on-transition state and the page, reading the signature [#129](https://github.com/l3a0/marketlake/issues/129) narrowed, a known field's name sitting in `extra`. A field that stops arriving leaves no signature at all, so it needs a second detection on that same producer.
